...
class PointPillarScatter(nn.Module):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        # print(f"batch_dict['spatial_features'].shape: {batch_dict['spatial_features'].shape}")
        return batch_dict
...
class PointPillarScatter3d(nn.Module):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        for batch_idx in range(batch_size):
            ...
            # Check if indices are greater than 219024
            mask = indices < self.nz * self.nx * self.ny
