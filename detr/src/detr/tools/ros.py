...
class Pointpillars_ROS:
    ...
    def init_ros(self):
        ...
        config_path = rospy.get_param("/config_path", "/home/ez/project/vod/tools/cfgs/astyx_models/pointpillar_fsa.yaml")
        ckpt_path = rospy.get_param("/ckpt_path", "/home/ez/project/vod/output/astyx_models/pointpillar_fsa/astyx_no_kde_fsa59/ckpt/checkpoint_epoch_68.pth")
