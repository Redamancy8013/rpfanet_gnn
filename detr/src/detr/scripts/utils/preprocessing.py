...
def parse_args():
    ...
    parser.add_argument('--programme_file', default='/home/ez/project/GnnPmbTracker-main')
    parser.add_argument('--dataset_folder',default='/home/ez/project/dataset')
...
def main(args):
    ...
    for data_version in dataset_versions:
        ...
        for i in range (10):
            ...
            scene_names.append(scenes[i]['name'])
            print(scenes[i]['name'])
