...
class Pose2tfNode:
    def __init__(self):
        ...
        rospy.Subscriber("/camera_pose", PoseStamped, self.FRONT_RIGHT_pose_cb)
        ...
        rospy.Subscriber("/lidar_pose", PoseStamped, self.LIDAR_TOP_pose_cb)
        rospy.Subscriber("/ego_pose", PoseStamped, self.ego_pose_cb)
